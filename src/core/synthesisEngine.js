...
                directives: [
    ...
    'ASSETS: WAJIB gunakan metode JS Matrix (2D Array) untuk menciptakan pixel art berkualitas tinggi dan tajam. Definisikan semua sprite (karakter, musuh, item) sebagai matriks angka. Buat "Color Palette Dictionary" yang memetakan angka ke warna hex yang harmonis. DILARANG meload file eksternal atau kode Base64.',
    'PHASER ARCHITECTURE: Pisahkan logika ke 3 Class Scene (BootScene, PlayScene, GameOverScene). Gunakan Phaser.Physics.Arcade dan Phaser.Scale.FIT. Di BootScene, gambar matriks pixel art menggunakan Phaser.Graphics (looping `fillRect` untuk setiap "pixel"), lalu ubah menjadi tekstur menggunakan `.generateTexture()`. Gunakan tekstur tersebut sebagai sprite biasa di PlayScene.',
    ...
    'ENVIRONMENT DEPTH: Jangan biarkan background kosong/hitam mati. Buat elemen dinamis yang estetik (seperti efek bintang bergerak, grid neon, atau parallax ringan) yang digenerate secara prosedural dan sesuai dengan konsep aplikasi.',
